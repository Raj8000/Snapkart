 ...
 <?php include 'include/navmodel.php';?>
  ...
  <div class="dark-wrapper">
    <div class="container inner2">
      ...
      <p class="text-center">All Photo By Selected Catagories</p>
	  ...
	  <?php
				...
				$sql="SELECT `catagoryid`,`filepath` FROM `photos` WHERE `mid`='$mmid' and `catagoryid`='$a'";
				$a="SELECT `catagoryid` FROM `photocatagory` WHERE `catagoryid`='$a'";
		//var_dump($sql);
		$res=mysqli_query($conn,$sql);
		$dis=mysqli_query($conn,$a);
		//var_dump($res);
...
while($row=mysqli_fetch_assoc($res))
	...
	*/
		echo"<div class='col-sm-6'>
         ...
         <div class='caption-overlay'>
		<a href='#'><img src='".$row["filepath"]."' alt=' 'width='900px' height='350px'/></a>
            <div class='caption bottom-right'>
              <div class='title'>
                <h3 class='main-title layer'>".$row["catagoryid"]."</h3>

...
poster='style/video/nyc.jpg'>
  ...
  <div class="light-wrapper">
    <div class="container inner">
      <div class="thin">
        <h3 class="section-title text-center">category</h3>
        <p class="text-center">photocategory</p>
      </div>
      <!-- /.thin -->
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="caption-overlay">
			...
			<div>
			<a href="login.php" class="btn btn-icon"><i class="icon-s-picture"></i>more category</a> 
			</div>
            <!--/.caption --> 

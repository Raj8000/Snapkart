...
<div class="navbar solid">
  ...
  <form method="get">
      <ul class="nav navbar-nav navbar-">
        <li class="active"><a href="modelhome.php">Home<span class="caret"></span></a>
        
        </li>
        <li class="active"><a href="mprofile.php" >Profile<span class="caret"></span></a>
           
        </li>
        <li class="active"><a href="category.php" >photo category<span class="caret"></span></a>
...
<!--   <ul class="nav navbar-nav navbar-right">
     <li class="dropdown"><a href="login.php" >login<span class="caret"></span></a>
          
        </li>
        <li class="dropdown"><a href="signup.php" >sign up<span class="caret"></span></a>
          
        </li>
       
      </ul> -->
      <ul class="nav navbar-nav navbar-right">
    <li><a href="#upload"><span class="glyphicon glyphicon-up-load"></span>Upload Photos</a></li>
    
      <li><a href="login.php?logout=TRUE" name="logout"><span class="glyphicon glyphicon"></span> Logout </a></li>
    </form>
    <li></li>
    </ul> <!-- /.navbar-nav --> 
    </nav>
    ...
    <div class="tp-fullscreen">
      <ul>
        <li data-transition="fade"> <img src="style/images/art/slider-bg1.jpg"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
          <h1 class="tp-caption large sfr" data-x="30" data-y="263" data-speed="900" data-start="800" data-easing="Sine.easeOut">hello! this is Snapkart</h1>
          <div class="tp-caption medium sfr" data-x="30" data-y="348" data-speed="900" data-start="1500" data-easing="Sine.easeOut">Welcome
		   <?php session_start(); 
...
poster='style/video/nyc.jpg'>
  ...
  <br>
	  <section id="upload">
	   ...
	   <h3 class="section-title text-center">Upload Photos</h3>
 ...
 <div align="center" class="fileupload fileupload-new" data-provides="fileupload">
	<span class="col-lg-5">
                                            ...
                                            <select name="c" class="form-control">
												<?php 
													...
													{
														echo"<option id=''>".$rrw['catagoryid']."</option>";
													}?>
    ...
    <span class="fileupload-preview"><input type="submit" name="img" value="UPLOAD"></span>
  </div>
  </form>
	</section>
<div class="light-wrapper">
    <div class="container inner">
      <div class="thin">
        <h3 class="section-title text-center">TimeLine</h3>
		<p class="text-center">All Catagories</p>
      </div>
      <!-- /.thin -->
...
if(isset($_SESSION))
{
				...
				$conn=mysqli_connect("localhost","root",""); 
					...
					//echo "connection successfully......<br><br>";
				$db=mysqli_select_db($conn,"snapkart");
				$sql="SELECT * FROM `photos` WHERE `mid`='$mmid'";
		//var_dump($sql);
		$res=mysqli_query($conn,$sql);
...
while($row=mysqli_fetch_assoc($res))
	...
	/*	echo"<div class='col-sm-4'>
		...
		echo"<div class='col-sm-4'>
         <div class='caption-overlay'>
		<a href='#'><img src='".$row["filepath"]."' alt='' width='350px' height='200px' /></a> 
            <div class='caption bottom-right'>
              <div class='title'>
                <h3 class='main-title layer'>".$row["catagoryid"]."</h3>
              </div>
            ...
            <div class="col-sm-6 col-md-4 grid-view-post">
              <div class="post">
                ...
                <div class="box text-center">
                  ...
                  <div class="meta"><span class="date">14 Aug 2015</span><span class="comments"><a href="#"><i class="icon-chat-1"></i> 15</a></span></div>
              ...
              <div class="item post">
                ...
                <div class="box text-center">
                  ...
                  <p>Maecenas sed diam eget risus varius blandit sit amet non magna. Donec ullamcorper nulla non metus auctor. Sed posuere consectetur est at. Duis mollis, est.</p>
				   ...
				   <div>
			<a href="login.php" class="btn btn-icon"><i class="icon-s-picture"></i>more events</a> 
			</div>
                </div>
      </div>
              </div>

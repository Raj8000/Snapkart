        ...
        <div class="top-content">
         ...
         <?php
			...
			if (isset($_POST['ftg']))
			{
				...
				$pass=$_POST['pwd'];
				$cpass=$_POST['cpwd'];
				$sql="SELECT * FROM `adagency` WHERE `aname`='$uname'";
				//echo "<h1>hello";
				//var_dump($sql);
 	...
 	<div class="l-form">
            ...
            <h4 class = "form-signin-heading"><?php echo $msg; ?></h4>
							<div class="form-group">
	                        	...
	                        	<input type="text" name="uname" placeholder="Username..." class="l-form-username form-control" id="l-form-username" required autofocus>
	                        </div>

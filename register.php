    ...
    <body>
                    ...
                    <div class="col-sm-4 col-sm-offset-1">
						...
						<div>
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<input type="text" name="memail" placeholder="Email..." class="r-form-email form-control" id="r-form-email" required>
	                        </div>
	                        <div class="form-group">
				            ...
				            <button type="submit" class="btn" name="msing">Sign me up!</button>
						</form>
		...
		<?php
				...
				if (isset($_GET['msing']))
				{
					...
					$sql="INSERT INTO `models`(`mimg`,`mid`, `mname`, `address`, `city`, `pincode`, `gender`, `email`, `contactno`, `password`) VALUES ('FIG',NULL,'$mname','$address','$cit','$pin','$gen','$mmemail','$contact','$pass')";
 	...
 	<div class="l-form">
		 ...
		 <p><a class="btn btn-link" href="login.php" color="white">Forget Password</a></p>

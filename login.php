...
if (isset($_POST['login']) && !empty($_POST['username']) && !empty($_POST['password']))
{
    ...
    $pass=$_POST['password'];
    $sql="SELECT * FROM `models` WHERE `mname`='$uname' and `password`='$pass'";
...
?>
        ...
        <h4 class = "form-signin-heading"><?php echo $msg; ?></h4>
         ...
         <p><a class="btn btn-link" href="registration.php" color="white">Register</a></p>
         <p><a class="btn btn-link" href="adlogin.php" color="white">Are you ad agency ?</a></p>
         <p><a class="btn btn-link" href="nforget.php" color="white">Forgot Password ?</a></p>

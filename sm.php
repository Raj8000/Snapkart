 ...
 <?php include 'include/navad.php';?>
  ...
  <div class="dark-wrapper">
    <div class="container inner2">
      <h3 class="section-title text-center">All Models</h3>
...
while($row=mysqli_fetch_assoc($ros))
	...
	/*	echo"<div class='col-sm-4'>
		...
		echo"<div class='col-sm-4'>
         <div class='caption-overlay'>
		<a href='smcat.php?cat=$r' name='cat'><img src='".$row["mimg"]."' alt='' width='350px' height='200px' /></a> 
            <div class='caption bottom-right'>
              <div class='title'>
                <h3 class='main-title layer'>".$row["mname"]."</h3>
              </div>
              <!--/.title --> 
            </div>
            <!--/.caption --> 
